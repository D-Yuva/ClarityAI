                      ...
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          ...
                          <h3 className="text-lg font-bold leading-tight">
                            <a href={video.link} target="_blank" rel="noreferrer" className="text-stone-900 hover:underline transition-colors">
                              {video.title}
                            </a>
                          </h3>
                        ...
                        if (thumbUrl && thumbUrl !== 'self' && thumbUrl !== 'default') {
                          return (
                            <div className="w-full h-48 sm:h-64 mt-4 mb-4 rounded-xl overflow-hidden bg-stone-100 border border-stone-200">
                              <img
                                src={`https://wsrv.nl/?url=${encodeURIComponent(thumbUrl)}`}
                                alt={video.title}
